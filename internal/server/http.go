...
func ServeHTTP(builders []qg.GameBuilder, completeFn func(qg.Game), snapshot *qgn.Snapshot, port string, allowedOrigins []string) {
	...
	s := &http.Server{
		Handler:      NewGameServer(game, completeFn, allowedOrigins),
