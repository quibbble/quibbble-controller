...
func Test_QGN_Parse(t *testing.T) {
	tests := []struct {
		name        string
		bgn         string
		shouldError bool
		...
		},
		{
			...
			bgn:         "[seed \"123\"][key \"carcassonne\"]",
			shouldError: true,
		},
		{
			name:        "tags only should succeed",
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"carcassonne\"]",
			shouldError: false,
		},
		{
		...
		},
		{
			...
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"Carcassonne\"]0",
			shouldError: true,
		},
		{
			name:        "missing team index should error",
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"Carcassonne\"]a",
			shouldError: true,
		},
		{
			name:        "large team index should succeed",
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"Carcassonne\"]10a",
			shouldError: false,
		},
		{
			name:        "too many ampersands should error",
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"carcassonne\"]10a&1.2&1.1",
			shouldError: true,
		},
		{
			name:        "complex bgn should succeed",
			bgn:         "[teams \"red, blue\"][seed \"123\"][key \"carcassonne\"][date \"11-01-2021\"]0a&1.2 {comment} 0b&1.2.T.R 1c 1a&1.3 1b&1.3.K.B",
			shouldError: false,
		},
		{
		...
		},
		{
			...
			bgn: `[key "tsuro"][teams "red, blue"][variant "classic"][seed "1696036843787"]
